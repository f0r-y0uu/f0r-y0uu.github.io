                        ...
                        Swal.fire({
                          ...
                          if (result.isConfirmed) {
                            ...
                            Swal.fire({
                              ...
                              Swal.fire('Okeyy deh', 'Nanti aku kabulin kemauan kamu yaa', 'success').then((result) => {

                                Swal.fire("jaga kesehatan yaa!^^").then((result) => {
                            ...
                            Swal.fire('Oh okedeh kalo ga ada').then((result) => {
                              ...
                              Swal.fire("jaga kesehatan ya! ^^").then((result) => {
